...
| Tool        | Description                                                                                                                                                    |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **look_at** | **Media Summary** fallback. Vision-capable callers receive the media directly; text-only callers delegate to Multimodal-Looker. Prefer a provider-native vision/MCP tool when available because delegation starts another model and can be slow. |
